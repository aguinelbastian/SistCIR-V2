...
//     USING: (has_role('opme'::text) AND (status = ANY (ARRAY['2_AGUARDANDO_OPME'::surgery_status, '5_AUTORIZADO'::surgery_status, '6_AGUARDANDO_MAPA'::surgery_status, '7_AGENDADO_CC'::surgery_status, '8_EM_EXECUCAO'::surgery_status])))
